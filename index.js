...
<html>
    ...
    <body>
      ...
      <p><a href=prod.prasannanimbalkar.me:3000/v1/verifyUserEmail?token=${token}&email=${emailAddress} >
        prod.prasannanimbalkar.me:3000/v1/verifyUserEmail?token=${token}&email=${emailAddress} </a> </p>
        </body></html>
    </body>
</html>`;
const params = {
