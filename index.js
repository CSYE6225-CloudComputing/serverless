...
exports.handler = async function (event) {
  ...
  //Putting an item to DynamoDB Table
    ...
    <html>
        ...
        <p><a href=http://prod.prasannanimbalkar.me/v1/user/verifyUserEmail?token=${token}&email=${email} >
            http://demo.prasannanimbalkar.me/v1/user/verifyUserEmail?token=${token}&email=${email} </a> </p>
            </body></html>
        </body>
    </html>`;
    ...
    Message: {
        ...
        Source: "sender@prod.prasannanimbalkar.me",
    };
